...
class svgSHub extends Component {
  render() {
    return (
      <div>
        <svg className="demo" width="1900px" height="507.584px" x="0px" y="0px">
          <Anime easing="easeOutQuad" key={11+Date.now()} 
            duration={1000}
            loop={false}
            ...
            <path className="target-path" fill="#C93B27" d="M976.348,169.925c10.836,0.007,21.729-4.156,29.992-12.426l0,0c8.273-8.27,12.439-19.166,12.434-30.004
            ...
            <path className="target-path" fill="#C93B27" d="M982.795,127.496V88.577c0-3.563-2.884-6.451-6.447-6.451l0,0c-3.563,0-6.453,2.888-6.453,6.451l0,0
            v38.919c0,3.56,2.89,6.448,6.453,6.448l0,0C979.911,133.943,982.795,131.055,982.795,127.496L982.795,127.496z"/>
            <path className="target-path" fill="#999999" d="M1212.563,170.312c-7.987,0-15.736-1.888-20.727-5.054c-5.292-3.344-9.635-8.477-12.911-15.246
            ...
            <path className="target-path" fill="#333333" d="M807.172,161.426"/>
            <path className="target-path" fill="#FFFFFF" d="M866.328,170.407c-11.55,0-20.789-4.017-27.457-11.938c-6.627-7.854-9.985-18.743-9.985-32.351
            ...
            <path className="target-path" fill="#FFFFFF" d="M682.645,170.312c-9.361,0-16.992-2.459-22.677-7.311c-5.691-4.862-9.013-11.699-9.861-20.318
            ...
            <path className="target-path" fill="#FFFFFF" d="M737.335,170.407c-4.434,0-7.687-1.29-9.667-3.833c-1.944-2.508-2.888-6.483-2.888-12.147V87.999
            ...
            <path className="target-path" fill="#FFFFFF" d="M787.725,163.814c7.96,0,13.96-2.05,17.361-5.931c3.48-3.979,5.248-10.609,5.248-19.713V81.646h6.905
            ...
            <path className="target-path" fill="#999999" d="M1134.354,163.814c7.957,0,13.959-2.05,17.359-5.931c3.479-3.979,5.246-10.609,5.246-19.713V81.646h6.906
            ...
            <polygon className="target-path" fill="#C93B27" points="915.371,74.395 915.371,50.318 939.959,50.318 915.396,74.395 		"/>
            <path className="target-path" fill="#FFFFFF" d="M922.275,170.437h-6.904V81.646h6.904V170.437z"/>
            <path className="target-path" fill="#999999" d="M1093.614,170.437h-7.063v-56.454c0-9.153-1.753-15.796-5.209-19.74
            ...
            <line opacity="0.3" fill="none" stroke="#FFFFFF" strokeMiterlimit="10" enableBackground="new " x1="650.467" y1="81.219" x2="1900" y2="81.219"/>
            <line opacity="0.3" fill="none" stroke="#FFFFFF" strokeMiterlimit="10" enableBackground="new " x1="650.467" y1="171.017" x2="1900" y2="171.017"/>
            <line opacity="0.3" fill="none" stroke="#FFFFFF" strokeMiterlimit="10" enableBackground="new " x1="0" y1="50.043" x2="1900" y2="50.043"/>
            <line opacity="0.3" fill="none" stroke="#FFFFFF" strokeMiterlimit="10" enableBackground="new " x1="650.47" y1="0" x2="650.47" y2="313.332"/>
            <line opacity="0.3" fill="none" stroke="#FFFFFF" strokeMiterlimit="10" enableBackground="new " x1="1019.569" y1="0" x2="1019.569" y2="313.332"/>
            <line opacity="0.3" fill="none" stroke="#FFFFFF" strokeMiterlimit="10" enableBackground="new " x1="932.921" y1="0" x2="932.921" y2="512.085"/>
            <line opacity="0.3" fill="none" stroke="#FFFFFF" strokeMiterlimit="10" enableBackground="new " x1="1251.47" y1="0" x2="1251.47" y2="313.332"/>
          </Anime>
        </svg>
      </div>
    );
