...
package com.gs {
	...
	public class TweenMax extends TweenFilterLite {
		...
		public function TweenMax($target:Object, $duration:Number, $vars:Object) {
			...
			_pauseTime = -1;
			if (TweenFilterLite.version < 7.2 || isNaN(TweenFilterLite.version)) {
		...
		public static function sequence($target:Object, $tweens:Array):Array { //Note: make sure each tween object has a "time" parameter (duration in seconds).
			...
			var dl:Number, t:Number, i:uint, o:Object, p:String, tw:Object;
			for (i = 0; i < $tweens.length; i++) {
				...
				a.push(new TweenMax($target, t, o));
				totalDelay += t + dl;
				overwrite = false;
			}
			return a;
		...
		public static function delayedCall($delay:Number, $onComplete:Function, $onCompleteParams:Array = null, $onCompleteScope:* = null):TweenMax {
			return new TweenMax($onComplete, 0, {delay:$delay, onComplete:$onComplete, onCompleteParams:$onCompleteParams, onCompleteScope:$onCompleteScope, overwrite:false});
		}
